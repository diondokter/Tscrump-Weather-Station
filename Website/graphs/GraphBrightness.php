...
$y_axis[$index] = $row["Brightness"]; // Gives the y_axis the Temperatures
...
$graph->title->Set('Brightness'); // Set's the title for the graph
...
$graph->yaxis->SetTitle("Percentage(%)", 'center'); // Set's the title for the y-axis
